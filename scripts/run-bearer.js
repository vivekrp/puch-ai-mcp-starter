...
async function runBearerServer() {
  console.log(chalk.blue.bold('\n🐍 Starting Python Bearer Token MCP Server\n'));
  ...
  const serverProcess = spawn(pythonPath, ['mcp_starter.py'], {
  ...
  setTimeout(() => {
    ...
    console.log(chalk.gray('4. Debug mode: /mcp diagnostics-level debug\n'));
  }, 2000);
}

runBearerServer().catch(console.error);
